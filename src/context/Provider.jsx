...
const Provider = ({ children }) => {
  ...
  const getDataProduct = () => {
    ...
    fetch("https://ztechnology.up.railway.app/api/product/consultar-productos")
      .then((res) => res.json())
      .then((res) => {
        setInfoCard(res);
      });
  ...
  const getDataUsers = () => {
    ...
    fetch("https://ztechnology.up.railway.app/api/usuarios/consultar-usuarios")
      .then((res) => res.json())
      .then((res) => {
  ...
  const getDataClients = () => {
    fetch("https://ztechnology.up.railway.app/api/client/clientAll")
      .then((res) => res.json())
      .then((res) => {
  ...
  const getDataOrder = () => {
    fetch("https://ztechnology.up.railway.app/api/order/ordersAll")
      .then((res) => res.json())
      .then((res) => {
